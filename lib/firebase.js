...
import { getFirestore, collection, query as firestoreQuery, where, limit, getDocs, Timestamp} from "firebase/firestore";
 ...
 */
 export async function getUserWithUsername(username) {
  ...
  const q = firestoreQuery(usersRef, where('username', '==', username),limit(1));
